...
for run in range(cnt_monte_carlo):
    ...
    for channel in range(0, 126, 1):
        ...
        print('Channel', channel, 'Packet Count:', count , 'ack_rate:', ack_rate,
